...
public class DriversLocation_db extends SQLiteOpenHelper {
    ...
    public static final String COL_1 = "_id"; //yo col1 use bhaxaena...th
    ...
    public DriversLocation_db(Context context) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_NAME +" (_id INTEGER PRIMARY KEY AUTOINCREMENT,salutation TEXT, fname TEXT, lname TEXT, nationality TEXT, phone VARCHAR,actype VARCHAR, license VARCHAR, vehicle VARCHAR, status VARCHAR, lat VARCHAR, lon VARCHAR)");
    ...
    public boolean insertDriverData(String salute,String fname,String lname,String country,String phone,String actype,String license,String vehicle,String statuss,String lat,String lon) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        //col1 lai rakheko xaena kina bhane primary key autoincrement hune wala xa
