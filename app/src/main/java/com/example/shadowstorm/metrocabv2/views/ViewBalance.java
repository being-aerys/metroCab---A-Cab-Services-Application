...
public class ViewBalance extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(nInfo !=null && nInfo.isConnected()) {
            String url = GlobalValues.MyAppUrl+"/metrocab/viewBalance.php?userPhone="+userPhone;
            myWebView = (WebView)findViewById(R.id.webViewBalance);
            ...
            Toast.makeText(ViewBalance.this, "NO Internet Connection", Toast.LENGTH_SHORT).show();
        }
