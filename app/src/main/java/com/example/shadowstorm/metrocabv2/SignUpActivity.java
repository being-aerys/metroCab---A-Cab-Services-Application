...
public class SignUpActivity extends Activity {
    ...
    EditText fname,lname,email,nation,phone,license,vehicle,username,password,paypal;
        ...
        btnAddUser.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final String rpaypal = paypal.getText().toString();
                        if (!rfname.equals("")) {
                            if (!rlname.equals("")) {
                                if (!rcountry.equals("")) {
                                    if (!rusername.equals("")) {
                                        if (!rpassword.equals("")) {
                                            if (!rsal.equals("")) {
                                                if(!rphone.equals("")) {
                                                                            ...
                                                                            new DialogInterface.OnClickListener() {
                                                                                public void onClick(DialogInterface dialog, int which) {
                                                                                    ...
                                                                                    if (codeb.equals(diceRoll)) {
                                                                                        ...
                                                                                        backgroundWorkers.execute(type, rsal, rfname, rlname, rcountry,rphone,ractype,rlicense,rvehicle,rusername,rpassword,rpaypal);
                                                    ...
                                                    } else {Toast.makeText(SignUpActivity.this, "Paypal Id is reequired", Toast.LENGTH_LONG).show();}
